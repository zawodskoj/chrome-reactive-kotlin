 ...
 */
open class DevToolsProtocol constructor(internal val connection: ChromeDebuggerConnection) : Closeable {
    ...
    init {
        ...
        connection.addEventMapping("Media.playerErrorsRaised", pl.wendigo.chrome.api.media.PlayerErrorsRaisedEvent::class.java)
        connection.addEventMapping("Media.playerEventsAdded", pl.wendigo.chrome.api.media.PlayerEventsAddedEvent::class.java)
        connection.addEventMapping("Media.playerMessagesLogged", pl.wendigo.chrome.api.media.PlayerMessagesLoggedEvent::class.java)
